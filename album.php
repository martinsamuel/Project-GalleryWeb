  ...
  <div class="mx-auto flex h-16 max-w-screen-xl items-center gap-8 px-4 sm:px-6 lg:px-8">
    ...
    <tbody>
        ...
        <td>
            ...
            <button type="button" class="btn btn-danger"><a href="hapus_album.php?albumid=<?=$data['albumid']?>" style="text-decoration: none; color: white;">Hapus</a></button>
            <button type="button" class="btn btn-primary"><a href="edit_album.php?albumid=<?=$data['albumid']?>" style="text-decoration: none; color: white;">Edit</a></button>
        </td>
        </tr>
    </tbody>
    <?php
