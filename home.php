...
<header class="bg-white">
  <div class="mx-auto flex h-16 max-w-screen-xl items-center gap-8 px-4 sm:px-6 lg:px-8">
    ...
    <h2 style="margin-top: 2%; margin-left: 5%;"><b>Your Post Photos</b></h2>
...
<div class="container">
    <div class="row">
        ...
        if (mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                <div class="col-md-4 mb-4">
                    <article class="overflow-hidden rounded-lg shadow transition hover:shadow-lg">
                        <img src="gambar/<?= $row['lokasifile'] ?>" alt="" class="h-56 w-full object-cover">
                        <div class="bg-white p-4 sm:p-6">
                            <time datetime="<?= $row['tanggalunggah'] ?>" class="block text-xs text-gray-500"><?= $row['tanggalunggah'] ?></time>
                            <a href="#">
                                <h3 class="mt-0.5 text-lg text-gray-900"><?= $row['judulfoto'] ?></h3>
                            </a>
                            <p class="mt-2 line-clamp-3 text-sm/relaxed text-gray-500"><?= $row['deskripsifoto'] ?></p>
                        </div>
                    </article>
                </div>
                <?php
            ...
            echo "<b>Status : Anda belum memosting apapun</b>";
        }
        ?>
    </div>
</div>
