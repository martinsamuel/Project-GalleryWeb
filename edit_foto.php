...
<body>
    ...
    <div class="card">
        ...
        <table>
            <tr>
                <td>Judul</td>
                <td><input type="text" class="form-control" name="judulfoto" value="<?=$data['judulfoto']?>" aria-describedby="basic-addon1"></td>
            </tr>
            <tr>
                <td>Deskripsi</td>
                <td><input type="text" class="form-control" name="deskripsifoto" value="<?=$data['deskripsifoto']?>" aria-describedby="basic-addon1"></td>
            </tr>
            <!-- <tr>
                <td>Lokasi File</td>
                <td><input type="file" class="custom-file-input" name="lokasifile"></td>
            </tr> -->
            <tr>
                <td for="lokasifile">Lokasi File</td>
                <td>
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" name="lokasifile">
                        <label class="custom-file-label" for="lokasifile">Pilih file...</label>
                    </div>
                </td>
            </tr>

            <tr>
                <td for="inputGroupSelect01">Album</td>
                <td>
                    <div class="input-group">
                        <select class="custom-select" id="inputGroupSelect01" name="albumid">
                        <?php
                        ...
                        ?>
                            ...
                            {echo 'selected';} ?>><?= $data2['namaalbum'] ?></option>
                            <?php
                            }
                            ?>
                        </select>
